...
def generate_final_feedback(profile: Dict[str, Any], evaluation: Dict[str, Any]) -> dict:
    prompt = f"""
You are a Hiring Manager + Mentor. Generate a structured report based on the interview results.

Profile:
{profile}

Collected interview results (ground truth):
...
Rules:
- In knowledge_gaps, include the correct answer.
- Roadmap must follow from knowledge_gaps.
